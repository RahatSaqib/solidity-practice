 ...
 function Navbar(){
    return(
      ...
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <span className="ml-3 text-xl">Hotel Zoo</span>
          </a>
          ...
          <button className="inline-flex items-center bg-red-400 border-0 py-1 px-3 focus:outline-none hover:bg-red-600 rounded text-base mt-4 md:mt-0">Sign Up
